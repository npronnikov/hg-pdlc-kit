# BMAD monorepo: обязательное техническое согласование
...
| ai-readiness | ai | Implementation readiness и карта решения человека | on_success → human-design-approval; on_approval → human-design-approval; on_architecture → ai-architecture; on_system → ai-srs; on_model → ai-test-model; on_plan → ai-stories; on_intent → ai-discover; on_blocked → terminal-blocked |
